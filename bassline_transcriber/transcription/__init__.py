...
from .representation import (transpose_to_C, encode_midi_array, NN_output_to_midi_array,
                NN_output_to_MIDI_file,unpack_repetitions, cont_NN_output_to_MIDI_file)