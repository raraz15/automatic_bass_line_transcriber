...
from .building_blocks import beat_plotting
...
def F0_related_stem(title, beat_positions, F0_estimate, pitch_track, quantized_pitch_track, midi_sequence, M):
